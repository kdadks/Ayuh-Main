...
const HomeopathyBlogs = () => {
  ...
  const handleFilterChange = (newFilters: BlogFiltersType) => {
    // Ensure category remains 'homeopathy' when filters change
    setFilters({ ...newFilters, category: 'homeopathy' });
  };
  ...
  const category = categories.find(c => c.slug === 'homeopathy');

  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Homeopathy Articles - Ayuh Healthcare</title>
        <meta
          name="description"
          content="Learn about natural healing methods, immune system support, and holistic health approaches through homeopathy."
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-bold mb-2">Homeopathy Articles</h1>
          {category && (
...
export default HomeopathyBlogs;
