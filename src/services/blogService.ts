...
### 🌡️ Seasonal Immune Strategies

<div class="seasonal-strategies bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-6 my-8">
  <h4 class="text-xl font-semibold text-gray-800 mb-6">Year-Round Immune Optimization</h4>
  
  <div class="seasons-grid grid grid-cols-1 md:grid-cols-4 gap-4">
    <div class="season-card bg-white rounded-lg p-4 border border-gray-200">
      <div class="text-center mb-3">
        <span class="text-3xl">🌸</span>
        <h5 class="font-medium">Spring</h5>
      </div>
      <ul class="text-xs space-y-1">
        <li>• Liver detox support</li>
        <li>• Allergy prevention</li>
    ...
    <div class="season-card bg-white rounded-lg p-4 border border-gray-200">
      <div class="text-center mb-3">
        ...
        <h5 class="font-medium">Summer</h5>
      </div>
      <ul class="text-xs space-y-1">
        <li>• Hydration focus</li>
        <li>• Heat stress protection</li>
        <li>• Active outdoor immunity</li>
      </ul>
    </div>
    ...
    <div class="season-card bg-white rounded-lg p-4 border border-gray-200">
      <div class="text-center mb-3">
        <span class="text-3xl">🍂</span>
        <h5 class="font-medium">Autumn</h5>
      </div>
      <ul class="text-xs space-y-1">
        <li>• Respiratory preparation</li>
        <li>• Immune system building</li>
    ...
    <div class="season-card bg-white rounded-lg p-4 border border-gray-200">
      <div class="text-center mb-3">
        <span class="text-3xl">❄️</span>
        <h5 class="font-medium">Winter</h5>
      </div>
      <ul class="text-xs space-y-1">
        <li>• Vitamin D support</li>
        <li>• Warming foods</li>
